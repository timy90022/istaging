...
class AELoss(nn.Module):
    ...
    def forward(self, outs, targets):
        ...
        # print(len(tl_heats),len(br_heats),len(tl_tags),len(br_tags),len(tl_regrs),len(br_regrs))
        # print(tl_heats[0].shape)
        # print(tl_tags[0].shape)
        # print(tl_regrs[0].shape)
        # print('***')
        ...
        # print(gt_tl_heat.shape)
        # print(gt_mask.shape)
        # print(gt_tl_regr.shape)
        ...
        for tl_tag, br_tag in zip(tl_tags, br_tags):
            # print('---123---')
            # print(tl_tag.shape,br_tag.shape,gt_mask.shape)
            # print(tl_tag.type(),br_tag.type(),gt_mask.type())
